...
?>
    ...
    <h1>Hemmeling melding følger</h1>
    <?php if ($_SESSION["tilgang"] == "OK") {
        //Tilgangskoden er sjekket og alt ok til å vise den hemmelige medlingen
        echo("<p>Denne teksten eksisterer ikke. Du har aldri sett den. Skjønner?</p>");
    } else {
        ...
        <a href="oppg2_hemmelig2.php">Se hva du skal gjøre her</a>
</body>
</html>