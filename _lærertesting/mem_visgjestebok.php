...
<!-- For hver rad i datasettet lager PHP en rad i HTML-tabellen
     med kolonner for feltene: Brukernavn, Dato, Innlegg -->
...
<table border =1>
    ...
    <?php while ($rad = $datasett->fetch_assoc()) { ?>
        <tr>
            ...
            <td><a style="text-decoration: none" href="mem_like.php?InnleggID=<?php echo htmlspecialchars($rad["InnleggID"]); ?>">👍</a></td>
        </tr>
    <?php } ?>
    </tbody>
</table>
